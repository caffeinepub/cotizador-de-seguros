...
import type { Quote as _Quote, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addInsurancePlan(arg0: string, arg1: string, arg2: Array<string>, arg3: bigint, arg4: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addInsurancePlan(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createQuote(arg0: string, arg1: bigint, arg2: string, arg3: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createQuote(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlans(): Promise<Array<InsurancePlan>> {
        if (this.processError) {
            try {
    ...
    async getQuotesByUser(arg0: Principal): Promise<Array<Quote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuotesByUser(arg0);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markQuotePaid(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.markQuotePaid(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async register(arg0: string, arg1: string, arg2: string, arg3: string): Promise<Principal> {
        if (this.processError) {
            try {
    ...
    async setUserActive(arg0: Principal, arg1: boolean): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateUserRole(arg0: Principal, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async validateSession(arg0: string): Promise<[Principal, string] | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [[Principal, string]]): [Principal, string] | null {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        clientAge: value.clientAge,
        planName: value.planName,
        paidAt: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.paidAt)),
